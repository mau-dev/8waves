...
class JamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jam" do
    assert_difference('Jam.count') do
      post jams_url, params: { jam: { content: @jam.content, title: @jam.title, user_id: @jam.user_id } }
    end
  ...
  test "should update jam" do
    patch jam_url(@jam), params: { jam: { content: @jam.content, title: @jam.title, user_id: @jam.user_id } }
